...
urlpatterns = [
    ...
    path('groups/add_students/<int:pk>', adminapp.add_students_to_group, name='add_students_to_group'),
    ...
    path('students/add_groups/<int:pk>', adminapp.add_groups_to_student, name='add_groups_to_student'),
